    ...
    if(rData.length<1){
        alert("No data matches your query.");
                ...
                for(let j=0; j<unique.length; j++){
                    ...
                    var ecpm_calc = totalRate/totalMinExposures;
        
                    document.getElementById("ecpm_average_title").innerHTML = 'RM'+abbrNum(ecpm_calc.toFixed(2),2);
...
//     maps_location += '<div class="col-md-12 header" style="background-color:#dadada;text-align:center">';
// 	maps_location += '<div class="item-card-img">';
// 	maps_location += '<img style="object-fit:cover;height:150px;width:300px" src="assets/img/billboards/no_img.jpg" alt="" id="location_img" onerror="this.src=\'assets/img/billboards/no_img.jpg\'">';
// 	maps_location += '</div></div><br>';
    ...
    for(let i = 0; i < vrItem.length; i++) {
        ...
        // maps_location  += '<div class="item-card-img">';
        maps_location  += '<a data-bs-target="#modaldemo6" data-bs-toggle="modal" onclick="javascript:setDetails(\''+obj.site_code+'\',\''+obj.road_site+'\',\''+obj.media_platform+'\')" style="color:black">';
        maps_location  += '<img class="mx-auto d-block" style="object-fit: cover;height:120px;margin-left:10px;" src="'+filename+'" alt="no image" onerror="javascript:this.src=\'assets/img/no-image.png\'" loading="lazy">';
        ...
        maps_location  += '<a data-bs-target="#modaldemo6" data-bs-toggle="modal" onclick="javascript:setDetails(\''+obj.site_code+'\',\''+obj.road_site+'\',\''+obj.media_platform+'\')" style="color:black"><h6 class="font-weight-semibold mt-1">'+obj.media_platform+'</h6></a>';
        maps_location  += '<p class="mt-1" style="font-size:12px">'+obj.road_site+'</p>';
